...
(function() {
  ...
  // }
  //
  // function Hero(monsterName, monsterHealth, attack) {
  //   LivingThing.call(this, monsterName, monsterHealth);
  //
  //    console.log("in Hero function ");
  //    console.log(Hero.monsterName);
  //               this.attack = function(LivingThing) {
  //   // console.log("this.attack function ");
  //                 this.setHealth(this.getHealth() - spentHealth());
  //                 LivingThing.setHealth(this.getHealth() - spentHealth());
  //   // console.log("this.health " + this.health);
  //   // console.log("LivingThing.health = " + LivingThing.health);
  //                 //return true;
  //               }
  //
  //               this.fight = function(LivingThing) {
  //                 for (let i = 0; i <= LivingThing.length - 1; i++){
  //   // console.log("i = " + i);
  //                   if (LivingThing[i].getHealth > 0){
  //                     Hero.attack(LivingThing[i]);
  //                   };
  //                 }
  //                 //return true;
  //               }
